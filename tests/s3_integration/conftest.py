...
Provides ``aws_s3`` and ``filesystem_storage`` fixtures that configure
environment variables, start/stop the Moto ``mock_aws`` context, provision
the test bucket, and yield a boto3 S3 client for direct assertions.
